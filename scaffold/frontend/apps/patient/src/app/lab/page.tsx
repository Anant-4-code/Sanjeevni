  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#0A0B0D] text-[#E8EAED]">
      <div className="p-8 max-w-md text-center border border-[#252830] bg-[#161920] rounded-xl space-y-4 shadow-xl">
        <h1 className="text-xl font-bold font-sans">Redirecting to Lab Portal...</h1>
        <p className="text-sm text-gray-400">
          The Lab Portal runs on port <span className="font-mono text-white font-semibold">5176</span>.
        </p>
        <a
        ...
        >
          Open Lab Portal (Port 5176) &rarr;
        </a>
      </div>
    </div>
  );
