-- Sanjeevani — Supabase Auth Sync Trigger to public.users
...
create table if not exists public.users (
  ...
  hospital_id uuid, -- FK to hospitals, can be null initially
...
-- 4. Create trigger function to sync auth.users to public.users
